...
{
    public class DostavljacZakljucenVM :BaseViewModel
    {
        ...
        public async Task Init()
        {
            ...
            narudzaResponse = izlaziService.GetActionResponseID("IzlaziDostavljaczakljucene", Global.prijavljeniDostavljac.DostavljacID);
